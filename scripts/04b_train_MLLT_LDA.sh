...
# LDA+MLLT
echo -e "\nLDA+MLLT step.\n"
$KALDI_DIR/egs/wsj/s5/steps/align_si.sh  --nj 14  $DATA_DIR/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/tri2a exp/system1_NoLengthContrast/tri2a_ali
$KALDI_DIR/egs/wsj/s5/steps/train_lda_mllt.sh   --splice-opts "--left-context=3 --right-context=3"   4200 40000 $DATA_DIR/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/tri2a_ali exp/system1_NoLengthContrast/tri2b
