...
. $KALDI_SCRIPTS/path.sh ## Source the tools/utils (import the queue.pl)
...
# 
  ...
  #  --config conf/decode.config exp/system1/tri3b/graph $DATA_DIR/dev exp/system1/dnn4b_nnet2/decode
