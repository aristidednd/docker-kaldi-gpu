...
$KALDI_DIR/egs/wsj/s5/steps/align_si.sh  --nj 14 --use-graphs true $DATA_DIR/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/tri2b exp/system1_NoLengthContrast/tri2b_ali
$KALDI_DIR/egs/wsj/s5/steps/train_sat.sh 4200 40000 $DATA_DIR/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/tri2b_ali exp/system1_NoLengthContrast/tri3b
...
steps/align_fmllr.sh --nj 14 $DATA_DIR/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/tri3b exp/system1_NoLengthContrast/tri3b_ali
